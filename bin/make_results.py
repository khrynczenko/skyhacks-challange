...
from lib.models import ModelTask1, FCNN1, FCNN2, FCNN3, FCNN_SC_1, FCNN_SC_2
...
# model = ModelTask1(53)
# model_t1 = FCNN_SC_1(4)
model_t1 = ModelTask1(53)
model_t2 = FCNN_SC_2(4)
model_t3 = FCNN3(4)
weights_t1_path = "weights/task1model-e38-resnet224.pt"
# weights_t1_path = "weights/task1model-e72-sc.pt"
weights_t2_path = "weights/task2model-e26-sc.pt"
...
image_names = []
images = []
with open("results-task1-e38-resnet-task2-e26-sc-task3-e40-th3.csv", "w", newline="") as csvfile:
    ...
    for entry in os.scandir(test_image_directory):
        ...
        image_t1 = cv2.resize(image, (224, 224))
        image_t2 = cv2.resize(image, (500, 500))
        image_t3 = cv2.resize(image, (224, 224))
