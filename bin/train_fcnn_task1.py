...
from lib.models import FCNN_skipped_connections
...
if __name__ == '__main__':
    ...
    artifacts_path = r'epochs-fcnn-skipped-connection/'
    ...
    part = int(0.05 * len(whole_dataset)) - 1
    ...
    model = FCNN_skipped_connections(4)
